...
namespace commands {
	...
	public:
		...
		template<typename T>
		T* Ptr() { return (T*)&executeOnPeer; }
		template<typename T>
		T& Ref() { return *(T*)&executeOnPeer; }
	...
	public:
		...
		Command(commands::ExecuteSend &&executeSend) :
				executeSend(), hasValue(true)
		{
